...
RSpec.describe "/boards", type: :request do
  ...
  # BoardsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get boards_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Board" do
        expect {
          post boards_url,
               params: { board: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Board" do
        expect {
          post boards_url,
               params: { board: invalid_attributes }, as: :json
        }.to change(Board, :count).by(0)
      end

      it "renders a JSON response with errors for the new board" do
        post boards_url,
             params: { board: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested board" do
        ...
        patch board_url(board),
              params: { board: new_attributes }, headers: valid_headers, as: :json
        board.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested board" do
      board = Board.create! valid_attributes
      expect {
        delete board_url(board), headers: valid_headers, as: :json
      }.to change(Board, :count).by(-1)
    end
  end
end
